...
//
//O restaurante especializado em coxinhas do pequeno distrito de Bueno de Andrada, interior de São Paulo, organiza
//essa competição todos os anos, mas nunca conseguiram entrar para o livro dos recordes, o Guinness Book.
//Para isso, o restaurante precisa preencher informações sobre a competição, como o número de coxinhas
...
//consumidas pelos participantes. O resultado deve ser escrito como um número racional com exatamente dois dígitos
//após o ponto decimal, arredondado se necessário.


package desafiosDIO.coxinha;
import java.util.Scanner;

public class Main {
    public static void main(String[] args){
        Scanner scan = new Scanner(System.in);
        String dadosRecebidos = scan.nextLine();
        String[] dadosSplitados = dadosRecebidos.split(" ");
        Double media = Double.parseDouble(dadosSplitados[0])/Double.parseDouble(dadosSplitados[1]);
